...
<body class="bg-gray-100">
    ...
    <div class="flex pt-20 min-h-screen">
        ...
        <div class="w-64 bg-white rounded-xl shadow-md p-6 border-l-4 border-[#2C3E50] min-h-screen sticky top-0 ml-4">
            <!-- ml-4 ensures there is a margin between sidebar and the edge of the screen -->
            <ul class="space-y-4">
                <li>
                ...
                <li>
                    <a href="/admin/consultations" class="flex items-center text-[#2C3E50] bg-gray-100 p-3 rounded-lg">
        ...
        <div class="flex-1 p-6">
            <div class="bg-white rounded-xl shadow-md p-6 mb-6 border-t-4 border-[#2C3E50]">
                <h2 class="text-2xl font-bold text-[#2C3E50] mb-6">Manage Consultations</h2>

                <!-- Create Consultation Button -->
                <div class="flex justify-end mb-4">
                    <a href="/admin/consultations/create"
                ...
                <div class="bg-gray-50 rounded-xl p-4">
                    <table class="w-full table-auto">
                        ...
                        <tbody>
                            <!-- PHP Loop for Consultations -->
                            <?php foreach ($consultations as $consultation): ?>
                                <tr class="border-b border-gray-200">
                                    <td class="py-2"><?= esc($consultation['date']) ?></td>
                                    <td class="py-2"><?= esc($consultation['description']) ?></td>
                                    <td class="py-2 text-right">
                                        <a href="/admin/consultations/edit/<?= esc($consultation['id']) ?>"
                                            class="text-blue-600 hover:text-blue-800 mr-2">
                                            <i data-lucide="edit" class="w-5 h-5"></i>
                                        </a>
                                        <a href="/admin/consultations/delete/<?= esc($consultation['id']) ?>"
